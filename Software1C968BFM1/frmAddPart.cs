...
namespace Software1C968BFM1
{
    public partial class frmAddPart : Form
    {
        ...
        private void tbInventory_Validating(object sender, CancelEventArgs e)
        {
            ...
            var isNumber = int.TryParse(tbInventory.Text, out conversionCheck);
            int.TryParse(tbMinQuantity.Text, out min);
            int.TryParse(tbMaxQuantity.Text, out max);
            ...
            {
                epValidator.SetError(tbInventory, "Inventory should be between the minimum and maximum amounts");
            }
            else
            {
        ...
        private void tbSource_Validating(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    epValidator.SetError(tbSource, "The company name should contain only letters");
                }
                else
                {
                    tbSource.BackColor = Color.White;
        ...
        private void tbMinQuantity_Validating(object sender, CancelEventArgs e)
        {
            ...
            int min, max;
            var isNumber = int.TryParse(tbMinQuantity.Text, out min);
            int.TryParse(tbMaxQuantity.Text, out max);
            ...
            {
                epValidator.SetError(tbMinQuantity, "The Minimum Inventory should less than the maximum");
            }
            else
            {
        ...
        private void tbMaxQuantity_Validating(object sender, CancelEventArgs e)
        {
            ...
            int min, max;
            var isNumber = int.TryParse(tbMaxQuantity.Text, out max);
            int.TryParse(tbMinQuantity.Text, out min);
            ...
            {
                epValidator.SetError(tbMaxQuantity, "The Maximum Inventory should be greater than the minimum");
            }
            else
            {
