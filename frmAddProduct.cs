...
namespace Software1C968BFM1
{
    public partial class frmAddProduct : Form
    {
        ...
        private void tbMin_Validating(object sender, CancelEventArgs e)
        {
            ...
            else if (!int.TryParse(tbMin.Text, out conversionCheck))
            {
        ...
        private void tbMax_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                epValidator.SetError(tbMax, "The minimum inventory amount is required");
            }
            else if (!int.TryParse(tbMin.Text, out conversionCheck))
            {
                epValidator.SetError(tbMax, "Minimum Inventory should be a number");
            }
            else
            {
                tbMin.BackColor = Color.White;
